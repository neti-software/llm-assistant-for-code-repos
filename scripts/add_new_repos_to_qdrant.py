...
def _process_repo(
    ...
    collection_name = repo_root.name
...
def ingest_directories(
    ...
    for org_dir in directories:
        ...
        for repo_root in _iter_repo_roots(org_dir):
            _process_repo(manager, repo_root, skip_existing, overwrite_existing)
...
def main() -> None:
    ...
    ingest_directories(repo_dirs, args.skip_existing, args.overwrite_existing)
